//  Typing Effect for Role in Hero Section
const roles = [
  "Front-end Developer",
  "Back-end Developer",
  "UI/UX Designer",
...
function erase() {
  if (charIndex > 0) {
    document.querySelector(".role").textContent = roles[roleIndex].substring(
      0,
      charIndex - 1
    );
    charIndex--;
...
function showAlert() {
  swal(
    "Oops!",
    "Live Demo not found. This project has not yet been deployed!",
    "error"
  );
}
